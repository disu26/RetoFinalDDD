...
public final class NombreDespachadorActualizado extends DomainEvent {
    private final DespachadorId despachadorId;
    private final Nombre nombre;

    public NombreDespachadorActualizado(DespachadorId despachadorId, Nombre nombre) {
        super("co.com.rappi.delivery.restaurante.events.NombreDespachadorActualizado");
